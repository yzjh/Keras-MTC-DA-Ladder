...
def get_ladder_network_fc(inputs_l, inputs_u,
                          layer_sizes=[784, 1000, 500, 250, 250, 250, 20],
                          noise_std=0.3,
    ...
    return y_c_l, y_l, u_cost

    # tr_m = Model([inputs_l, inputs_u], y_c_l)
    # tr_m.add_loss(u_cost)
    # tr_m.compile(keras.optimizers.sgd(lr=0.01), 'categorical_crossentropy', metrics=['accuracy'])
